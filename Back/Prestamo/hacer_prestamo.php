            ...
            <div class='card'>
               ...
               <div class='card-body'>
                  <div class='table-responsive-md'>
                     ...
                     <form method='post'>
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control" name="id_libro" id="id_libro"
                              aria-describedby="helpId" placeholder="Numero de identificación del Libro" required />
                     ...
                     <div class="mb-3">
                        <?php echo "Este es el Id del libro digitado: " . $prestamo->getId_libro() . "<br>" ?>
                     ...
                     <div class="mb-3">
                        ...
                        mostrar_datos($informacion_libro, $nombre_columna) ?>"
                           ...
                           placeholder="Categoria" <?php estado_input($informacion_libro); ?> />
                     </div>
                     <div class="mb-3">
                        <label for="" class="form-label">Número estanteria</label>
                        <input type="number" value="<?php $nombre_columna = "No_estanteria";
                        mostrar_datos($informacion_libro, $nombre_columna) ?>"
                           class="form-control" name="no_estanteria" id="no_estanteria" aria-describedby="helpId"
